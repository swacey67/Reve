...
export const STOCK_DATA = {
  'cloud-white': {
    ...
    reviews: [
      { id: 1, user: 'Elena R.', rating: 5, text: 'Estetik dan praktis. Es tetap beku selama lebih dari 18 jam!' },
      { id: 2, user: 'Marcus J.', rating: 4, text: 'Gelas harian terbaik yang pernah saya punya. Sangat direkomendasikan.' }
    ]
  },
  'blush-pink': {
    title: 'Blush Pink',
    ...
    reviews: [
      { id: 1, user: 'Siti A.', rating: 5, text: 'Warnanya cantik banget aslinya!' }
    ]
  },
  'sage-green': {
    title: 'Sage Green',
  ...
  'obsidian-black': {
    ...
    reviews: [
      { id: 1, user: 'Rian K.', rating: 5, text: 'Keren banget buat dibawa ngantor.' }
    ]
  }
};
