...
// MENGIMPORT GAMBAR LANGSUNG DARI ASSETS (Vite akan mengurus path-nya otomatis!)
import chainsawImg from '../assets/images/chainsaw.jpg';
import jjkImg from '../assets/images/jjk.jpg';
import vagabondImg from '../assets/images/vagabond.jpg';
      ...
      <div className={innerClass}>
        <svg width="240" height="360" viewBox="-50 -50 240 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="overflow-visible">
          <defs>
            ...
            {/* Memasukkan Variabel Gambar yang Sudah Diimport */}
            <pattern id="collabPattern" width="180" height="360" patternUnits="userSpaceOnUse">
              <image href={chainsawImg} width="180" height="360" preserveAspectRatio="xMidYMid slice" />
            </pattern>
            <pattern id="jjkPattern" width="180" height="360" patternUnits="userSpaceOnUse">
              <image href={jjkImg} width="180" height="360" preserveAspectRatio="xMidYMid slice" />
            </pattern>
            <pattern id="vagabondPattern" width="180" height="360" patternUnits="userSpaceOnUse">
              <image href={vagabondImg} width="180" height="360" preserveAspectRatio="xMidYMid slice" />
            </pattern>
          </defs>

          {/* ... (Kode bagian handle, top, bottom, head tetap sama persis) ... */}
